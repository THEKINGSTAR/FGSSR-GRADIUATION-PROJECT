...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230614140445_newInitial')
BEGIN
    ALTER TABLE [Teams] ADD [Deacription] nvarchar(max) NULL;
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230614140445_newInitial')
BEGIN
    ALTER TABLE [Teams] ADD [TeamTag] nvarchar(max) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230614140445_newInitial', N'7.0.5');
END;
GO
